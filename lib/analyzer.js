        ...
        this.Genoset.slice(0).reverse().forEach(e => {
            try {
                ...
                if (value) {
                    ...
                    console.outputGenoset(e.gsid, e.magnitude, e.repute, e.summary)
                }
            } catch (e) {
...
*/
        ...
        if (!vars) {
            ...
            if (rsSNP.referenceallele) {
                ...
                /*if (rsSNP.orientation == 'minus') {
                    ...
                    genotype = genotype.map(e => [...e].reverse().join(''))
                }*/
            }
        ...
        genotype = genotype.sort()
        const gsid = 'rs' + rsSNP.rsid + '(' + genotype.join(';') + ')'
